...
import (
	...
	"github.com/moontrade/kirana/logger/slog/internal/buffer"
...
func TestJSONAndTextHandlers(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			wantJSON:  `{"source":{"function":"github.com/moontrade/kirana/logger/slog.TestJSONAndTextHandlers","file":"handler_test.go","line":$LINE},"msg":"message"}`,
		},
	} {
