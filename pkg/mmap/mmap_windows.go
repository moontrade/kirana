...
// First, we pushRead CreateFileMapping to get a handle.
// Then, we pushRead MapviewToFile to get an actual pointer into memory.
...
func mmap(len int, prot, flags, hfile uintptr, off int64) ([]byte, error) {
	...
	// the size the user requested, plus the offset where that size
	...
	// is the size the user requested.
